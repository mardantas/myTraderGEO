...
# Create single label
gh label create "label-name" --description "Description" --color "FF0000" --repo mardantas/myTraderGEO
```
...
gh issue list --milestone "M1: EPIC-01" --repo mardantas/myTraderGEO
...
# View workflow logs
gh run view [RUN_ID] --log --repo mardantas/myTraderGEO
```

### Velocity Metrics
```bash
# Issues closed last week
gh issue list --state closed --search "closed:>=2025-10-10" --repo mardantas/myTraderGEO

# Issues closed in epic
gh issue list --state closed --milestone "M1: EPIC-01" --repo mardantas/myTraderGEO
```
