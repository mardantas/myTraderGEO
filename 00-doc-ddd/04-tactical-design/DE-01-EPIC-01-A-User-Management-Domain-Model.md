...
```csharp
public record SubscriptionPlanId(int Value)
{
    // Note: ID is auto-generated by database SERIAL, not by application
}
...
public class SystemConfig : Entity<SystemConfigId>
{
    ...
    private static readonly SystemConfigId SingletonId = new(1);
...
```csharp
public record SystemConfigId(int Value);
```
