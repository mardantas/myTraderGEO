...
2. **DBA** documenta schema em `DBA-01-EPIC-01-C-Schema-Review.md`
...
- **DBA Schema Review:** `00-doc-ddd/05-database-design/DBA-01-EPIC-01-C-Schema-Review.md` (to be created by DBA)
